<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT USERNAME FROM diaxeiristis WHERE USERNAME = '$myusername' and PASSWORD = '$mypassword'";
...
<div class="center">
<div class="container">
	<h1 align="center"> <font color=#F0F0F0 ><b>Είσοδος Διαχειριστή</b></font></h1>
  <br>
