<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT KAT_USERNAME FROM ypal_kat WHERE KAT_USERNAME = '$myusername' and KAT_PASSWORD = '$mypassword'";
      ...
      if($count == 1) {
        // session_register("myusername");
		 ...
		 header("location: ypal_kat_welcome.php");
...
<div class="center">
<div class="container">
	<h1 align="center"> <font color=#F0F0F0 ><b>Είσοδος Υπαλλήλου Καταστήματος</b></font></h1>
  <br>
